...
// CartDetailsComponent is now standalone and will be lazy loaded
import { CartsComponent } from './carts/carts.component';
import { ListgroupsComponent } from './listgroups/listgroups.component';
import { UsersComponent } from './users/users.component';

// Import standalone component directly in the route configuration
const loadAdminOrders = () => import('./admin-orders/admin-orders.component').then(m => m.AdminOrdersComponent);
